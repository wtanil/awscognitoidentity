...
NSString *const CognitoIdentityPoolId = @"us-east-1:070d5547-ff5f-47e7-bb97-3709743155bc";
...
// app to production.
// !!!!!!!!!!!!!!!!!!!
NSString *const DeveloperAuthEndpoint = @"http://ec2-54-173-31-135.compute-1.amazonaws.com/test/";
// Set to the provider name you configured in the Cognito console.
NSString *const DeveloperAuthProviderName = @"login.testproject.testPHPCognitoId";
